...
class graph_ranges
{
  ...
  protected:
   ...
   static int inline is_inside(const code_area<T2> &ca1, T2 end1, const code_area<T2> &ca2, T2 end2)
   {
   ...
   template <typename T2>
   static int interleaved(const code_area<T2> &ca, code_area<T2> &our)
   {
